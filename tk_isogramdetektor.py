...
2. Прописать список(или строку) содердащую все элементы алфавита: a-z.
3. Прописать логику, при которой элементы строки, полученной  в п.1 поиндексно проверяются на наличие в строке полученной в п.2 /n 
   подсчитываются, сравниваются.
